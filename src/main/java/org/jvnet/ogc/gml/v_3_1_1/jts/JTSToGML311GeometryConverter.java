...
public class JTSToGML311GeometryConverter
  ...
  public JTSToGML311GeometryConverter(
    ...
    this.pointConverter =
        new JTSToGML311PointConverter(objectFactory, srsReferenceGroupConverter, this.coordinateConverter);
    this.linearRingConverter =
        new JTSToGML311LinearRingConverter(objectFactory, srsReferenceGroupConverter, this.coordinateConverter);
    this.lineStringConverter =
        new JTSToGML311LineStringConverter(objectFactory, srsReferenceGroupConverter, this.coordinateConverter);
    this.polygonConverter =
        new JTSToGML311PolygonConverter(objectFactory, srsReferenceGroupConverter, this.linearRingConverter);
    this.multiPointConverter =
        new JTSToGML311MultiPointConverter(objectFactory, srsReferenceGroupConverter, this.pointConverter);
    this.multiLineStringConverter =
        new JTSToGML311MultiLineStringConverter(objectFactory, srsReferenceGroupConverter, this.lineStringConverter);
    this.multiPolygonConverter =
        new JTSToGML311MultiPolygonConverter(objectFactory, srsReferenceGroupConverter, this.polygonConverter);
    this.multiGeometryConverter =
        new JTSToGML311MultiGeometryConverter(objectFactory, srsReferenceGroupConverter, this);
  }
  ...
  public GeometryPropertyType createPropertyType(Geometry geometry) {
    final GeometryPropertyType geometryPropertyType = getObjectFactory().createGeometryPropertyType();
